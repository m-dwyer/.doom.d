#+TITLE: %(format-time-string "W%W, %B")
...
** Clocked Tasks
#+BEGIN: clocktable :properties ("Effort") :indent nil :scope agenda-with-archives :block %(format-time-string "%Y-W%W") :stepskip0 t :fileskip0 t :formula "@1$2=string(\"Est. effort\")::@1$4=string(\"Time\")"
#+END: clocktable
